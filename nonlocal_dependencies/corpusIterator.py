...
def addTrees(sec, trees):
    ...
    files = sorted(os.listdir("/Users/lianwang/Desktop/Summer 2022/Dependencies_Project/code/data/wsj/" + secNum))

    # for each filename in list of filenames
    for filename in files:
        for tree in ptb.parsed_sents("wsj/" + secNum + "/" + filename):
            # leaves = []
...
with open("ptb-ud2.conllu.txt", "r") as inFile:
